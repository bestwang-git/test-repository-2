...
public:
    ...
    /**
     * Log rpc query message. 
     */
    FILE* logQueryStr( const std::string& queryStr );

     /**
     * Log rpc-reply query result message.
     *
     */
    FILE* logQueryResult( const std::string& queryStr);
...
protected:
    ...
    /**
     * Remove duplicate log after it is concatenated 
     * and appended to a result log.
     *
     */
    void removeLog(const char* log);
