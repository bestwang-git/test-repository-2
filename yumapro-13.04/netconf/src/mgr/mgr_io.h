...
/* Callback function for session_closed
 *
 * INPUTS:
 *    unint32: sid 
 * RETURNS: void
...
typedef void (*mgr_ses_closed_fn_t) (uint32);
...
/********************************************************************
 * FUNCTION mgr_ses_close_handler
 *
 * Set the callback function for session closed
 *
 * INPUTS:
 *   handler == address of the session closed handler function
 *********************************************************************/
extern void
