...
*								    *
*********************************************************************/
#define YANGDIFF_PROGNAME   (const xmlChar *)"yangdiff-pro"
...
#define YANGDIFF_DEF_CONFIG        (const xmlChar *)\
    "/etc/yumapro/yangdiff-pro.conf"
#define YANGDIFF_DEF_FILENAME      (const xmlChar *)"yangdiff-pro.log"

#define YANGDIFF_MOD               (const xmlChar *)"yangdiff-pro"
#define YANGDIFF_CONTAINER         (const xmlChar *)"yangdiff-pro"
