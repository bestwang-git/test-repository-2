...
typedef enum agt_transaction_model_t_ {
    AGT_TM_NONE,   // this value is used
    AGT_TM_SHARED,
    AGT_TM_PRIVATE
...
typedef struct agt_profile_t_ {
    ...
    boolean             agt_edit_direct;
    boolean             agt_edit_transaction;
...
/********* Server Instrumentation Library Callbacks ***********/
...
/* struct to keep track of the dynamic external
 * system hooks library
 */
typedef struct agt_syslib_cb_t_ {
    dlq_hdr_t             qhdr;
    void                 *handle;
    xmlChar              *libspec;
