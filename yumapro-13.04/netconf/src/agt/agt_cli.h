...
#define AGT_CLI_MODULE     (const xmlChar *)"netconfd-pro"
#define AGT_CLI_CONTAINER  (const xmlChar *)"netconfd-pro"
...
#define AGT_CLI_MAX_SESSIONS (const xmlChar *)"max-sessions"
