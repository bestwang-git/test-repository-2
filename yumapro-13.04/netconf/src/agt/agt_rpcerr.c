                ...
                const xmlChar **apptag)
{
    ...
    *apptag = RPC_ERR_APPTAG_GEN_ERROR;
    ...
    case ERR_NCX_TOP_LEVEL_MANDATORY_FAILED:
        *apptag = RPC_ERR_APPTAG_GEN_ERROR;
        return RPC_ERR_OPERATION_FAILED;
    case ERR_NCX_RESOURCE_UNKNOWN:
        *apptag = RPC_ERR_APPTAG_DATA_INVALID;
        return RPC_ERR_INVALID_VALUE;
    case ERR_NCX_UNENDED_BLOCK:
        *apptag = RPC_ERR_APPTAG_DATA_INVALID;
        return RPC_ERR_INVALID_VALUE;
    case ERR_NCX_EVAL_VERSION:
        *apptag = RPC_ERR_APPTAG_NO_ACCESS;
        return RPC_ERR_OPERATION_FAILED;
    case ERR_NCX_RESOURCE_INSTANCE_UNKNOWN:
        *apptag = RPC_ERR_APPTAG_DATA_INVALID;
        return RPC_ERR_INVALID_VALUE;
    case ERR_NCX_UNEXPECTED_INPUT:
        *apptag = RPC_ERR_APPTAG_DATA_INVALID;
        return RPC_ERR_INVALID_VALUE;
    case ERR_NCX_METHOD_NOT_ALLOWED:
        *apptag = RPC_ERR_APPTAG_NO_ACCESS;
        return RPC_ERR_ACCESS_DENIED;
    case ERR_NCX_QPARAM_NOT_ALLOWED:
        *apptag = RPC_ERR_APPTAG_DATA_INVALID;
        return RPC_ERR_INVALID_VALUE;
    case ERR_NCX_PRECONDITION_FAILED:
        *apptag = RPC_ERR_APPTAG_GEN_ERROR;
        return RPC_ERR_OPERATION_FAILED;
    case ERR_NCX_HEADER_NOT_ALLOWED:
        *apptag = RPC_ERR_APPTAG_DATA_INVALID;
        return RPC_ERR_INVALID_VALUE;
                               ...
                               const void *errparm4)
{
    ...
    case RPC_ERR_BAD_ATTRIBUTE:
         ...
         */
        if (errparm2) {
            /* check if the attribute was qualified or unqualified */
            boolean qname_err = (badnsid1 > 0);
            res = enque_error_info(err, xmlns_nc_id(), NCX_EL_BAD_ATTRIBUTE, 
                                   qname_err, NCX_BT_STRING, badnsid1,
...
*********************************************************************/
rpc_err_t
    agt_rpcerr_get_rpcerr (status_t intres)
{
    rpc_err_sev_t errsev = RPC_ERR_SEV_NONE;
    const xmlChar *apptag = NULL;

    rpc_err_t errtyp = get_rpcerr(intres, TRUE, &errsev, &apptag);
    return errtyp;
...
#ifdef WITH_YANGAPI
/********************************************************************
* FUNCTION agt_rpc_get_http_status_code
*
* Translate the rpc_err_t to an HTTP code
*
* INPUTS:
*   rpcerr == RPC error code to translate
*
* RETURNS:
*   numeric code
*********************************************************************/
uint32
    agt_rpcerr_get_http_status_code (rpc_err_t rpcerr)
{
    switch (rpcerr) {
    case RPC_ERR_NONE:
        return 200;
    case RPC_ERR_IN_USE:
    case RPC_ERR_LOCK_DENIED:
    case RPC_ERR_RESOURCE_DENIED:
    case RPC_ERR_DATA_EXISTS:
    case RPC_ERR_DATA_MISSING:
        return 409;
    case RPC_ERR_INVALID_VALUE:
    case RPC_ERR_MISSING_ATTRIBUTE:
    ...
    case RPC_ERR_UNKNOWN_ELEMENT:
    case RPC_ERR_UNKNOWN_NAMESPACE:
    case RPC_ERR_MALFORMED_MESSAGE:
        return 400;
    case RPC_ERR_TOO_BIG:
        return 413;
    case RPC_ERR_ACCESS_DENIED:
        return 403;
    case RPC_ERR_ROLLBACK_FAILED:
    case RPC_ERR_OPERATION_FAILED:
    case RPC_ERR_PARTIAL_OPERATION:    /* deprecated; not used */
        return 500;
    case RPC_ERR_OPERATION_NOT_SUPPORTED:
        return 501;
    default:
        SET_ERROR(ERR_INTERNAL_VAL);
        return 500;
...
#ifdef WITH_YANGAPI
/********************************************************************
* FUNCTION agt_rpc_get_http_status_string
*
...
*********************************************************************/
const xmlChar *
    agt_rpcerr_get_http_status_string (uint32 status)
{
    switch (status) {
    case 100:
        return (const xmlChar *)"100 Continue";
    case 200:
        return (const xmlChar *)"200 OK";
    case 201:
        return (const xmlChar *)"201 Created";
    case 202:
        return (const xmlChar *)"202 Accepted";
    case 203:
        return (const xmlChar *)"203 Non-Authoritative Information";
    case 204:
        return (const xmlChar *)"204 No Content";
    case 205:
        return (const xmlChar *)"205 Reset Content";
    case 206:
        return (const xmlChar *)"206 Partial Content";
    case 300:
        return (const xmlChar *)"300 Multiple Choices";
    case 301:
        return (const xmlChar *)"301 Moved Permanently";
    case 302:
        return (const xmlChar *)"302 Found";
    case 303:
        return (const xmlChar *)"303 See Other";
    case 304:
        return (const xmlChar *)"304 Not Modified";
    case 305:
        return (const xmlChar *)"305 Use Proxy";
    case 307:
        return (const xmlChar *)"307 Temporary Redirect";
    case 400:
        return (const xmlChar *)"400 Bad Request";
    case 401:
        return (const xmlChar *)"401 Unauthorized";
    case 402:
        return (const xmlChar *)"402 Payment Required";
    case 403:
        return (const xmlChar *)"403 Forbidden";
    case 404:
        return (const xmlChar *)"404 Not Found";
    case 405:
        return (const xmlChar *)"405 Method Not Allowed";
    case 406:
        return (const xmlChar *)"406 Not Acceptable";
    case 407:
        return (const xmlChar *)"407 Proxy Authentication Required";
    case 408:
        return (const xmlChar *)"408 Request Timeout";
    case 409:
        return (const xmlChar *)"409 Conflict";
    case 410:
        return (const xmlChar *)"410 Gone";
    case 411:
        return (const xmlChar *)"411 Length Required";
    case 412:
        return (const xmlChar *)"412 Precondition Failed";
    case 413:
        return (const xmlChar *)"413 Request Entity Too Large";
    case 414:
        return (const xmlChar *)"413 Request-URI Too Large";
    case 415:
        return (const xmlChar *)"415 Unsupported Media Type";
    case 416:
        return (const xmlChar *)"416 Requested Range Not Satisfiable";
    case 417:
        return (const xmlChar *)"417 Expectation Failed";
    case 500:
        return (const xmlChar *)"500 Internal Server Error";
    case 501:
        return (const xmlChar *)"501 Not Implemented";
    case 502:
        return (const xmlChar *)"502 Bad Gateway";
    case 503:
        return (const xmlChar *)"503 Service Unavailable";
    case 504:
        return (const xmlChar *)"504 Gateway Timeout";
    case 505:
        return (const xmlChar *)"505 HTTP Version Not Supported";
    default:
        SET_ERROR(ERR_INTERNAL_VAL);
        return (const xmlChar *)"500 Internal Server Error";        
    }
