...
#
LIBNCX_MAJOR_VERSION=13
LIBNCX_MINOR_VERSION=04
...
CINC +=-I. -I../agt -I../mgr -I../ncx -I../platform -I../ydump -I../ycli \
...
CWARN=-Wall -Wno-long-long -Wformat-y2k -Winit-self \
	...
	-Wpacked -Winvalid-pch -Wformat=2 \
