...
#define YANGDUMP_DEF_CONFIG   (const xmlChar *)"/etc/yumapro/yangdump-pro.conf"

#define YANGDUMP_DEF_TOC      (const xmlChar *)"menu"

#define YANGDUMP_DEF_OBJVIEW  OBJVIEW_RAW

#define YANGDUMP_MOD          (const xmlChar *)"yangdump-pro"
#define YANGDUMP_CONTAINER    (const xmlChar *)"yangdump-pro"
