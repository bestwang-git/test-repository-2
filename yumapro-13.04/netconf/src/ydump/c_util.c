...
*            ignored if usename == TRUE
*   typeonly == TRUE if just the type name and possibly star are needed
*               FALSE for full function
**********************************************************************/
void
                         ...
                         boolean typeonly)
{
    ...
    case NCX_BT_UNION:
        ...
        //  do not rely on string; pass val and parse in the
        // u_foo handler function to save time and memory
        // used to convert back and forth to string
