...
typedef enum ses_transport_t_ {
    SES_TRANSPORT_NONE,
    SES_TRANSPORT_SSH,
    SES_TRANSPORT_BEEP,  /* not used */
    SES_TRANSPORT_SOAP, /* not used */
    SES_TRANSPORT_SOAPBEEP, /* not used */
    SES_TRANSPORT_TLS, /* not used */
    SES_TRANSPORT_TCP,   /* tail-f NETCONF over TCP */
    SES_TRANSPORT_HTTP,   /* YumaPro REST API ncxconnect, no framing */
    SES_TRANSPORT_CLI,    /* YumaPro CLI hook (ncxconnect, NETCONF framing) */
    SES_TRANSPORT_WEBUI     /* YumaPro WEBui (ncxconnect, no framing) */
} ses_transport_t;
...
typedef struct ses_cb_t_ {
    ...
    boolean          keep_xmlns;    /* T: parse extern, F: msg  */
    boolean          warn_xml;      /* T: xml warns, F: no warn */
    boolean          direct_mode;     /* T: yp-shell, F: normal */
    boolean          msg_mode;         /* T:msg-indent F:indent */
...
#ifdef WITH_YANGAPI
    struct yangapi_cb_t_ *rcb;        /* YANG-API control block */
#endif

#ifdef WITH_CLI
    //struct agt_cli_cb_t_ *cli_cb;          /* CLI control block */
#endif
    ...
    /*** user preferences ***/
    int8             indent;          /* indent N spaces (0..9) */
    int8             msg_indent;      /* indent N spaces (-1..9) */
...
*   none
*********************************************************************/
extern void ses_start_msg_mode (ses_cb_t *scb);
...
*   none
*********************************************************************/
extern void ses_stop_msg_mode (ses_cb_t *scb);
