...
*    collapse_submods == TRUE if OK to move submod defs to main mod
*                        FALSE if not
*    xpath_backptrs TRUE if XPath backptr caching needed;
...
/********************************************************************
* FUNCTION ncx_match_any_object_ex
*
* Check if an obj_template_t in in any module that
* matches the object name string; extended parameters
*
* INPUTS:
*   modname == module name of object (may be NULL)
*   objname == object name to match
...
*   modQ Q == Q of ncx_module_t * to add to; 
*          -- NULL will pick ncx_curQ
* RETURNS:
*   status of the operation
*********************************************************************/
extern status_t 
...
*********************************************************************/
extern void
    ncx_free_backptr (ncx_backptr_t *ptr);
...
*********************************************************************/
extern void
    ncx_clean_backptrQ (dlq_hdr_t *backptrQ);
