...
typedef enum status_t_
{
    ...
    ERR_NCX_RESOURCE_UNKNOWN,           /* 385 */
    ERR_NCX_UNENDED_BLOCK,              /* 386 */
    ERR_NCX_EVAL_VERSION,               /* 387 */
    ERR_NCX_RESOURCE_INSTANCE_UNKNOWN,  /* 388 */
    ERR_NCX_UNEXPECTED_INPUT,           /* 389 */
    ERR_NCX_METHOD_NOT_ALLOWED,         /* 390 */
    ERR_NCX_QPARAM_NOT_ALLOWED,         /* 391 */
    ERR_NCX_PRECONDITION_FAILED,        /* 392 */
    ERR_NCX_HEADER_NOT_ALLOWED,         /* 393 */
    ERR_LAST_USR_ERR,                   /* 394 -- not really used */
